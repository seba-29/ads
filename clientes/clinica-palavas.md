...
> ⚠️ **Tiene 4 cuentas.** La operativa es 65286325. Además: 515114076732289 🔴 DISABLED por actividad inusual con todos los anuncios pausados; 2713708302363847 (Read-Only, USD); 2155264505256773 (Read-Only, **INR** — revisar si es intencional).

## Identificación
| | |
|---|---|
| **Cuenta publicitaria** | `65286325` |
| **Business Manager** | Palavasdepilacionlaser |
| **Moneda** | CLP |
| **Estado de la cuenta** | ✅ ACTIVE (la operativa) |
| **Rubro** | |
| **Web / IG** | |
