...
> ⚠️ **Cambió de estado durante la sesión**: hace ~1h figuraba ACTIVE y ahora está UNSETTLED (saldo impago). Revisar facturación antes de tocar campañas.
...
| **Moneda** | CLP |
| **Estado de la cuenta** | 🔴 UNSETTLED — no consultable |
| **Rubro** | |
| **Web / IG** | |
